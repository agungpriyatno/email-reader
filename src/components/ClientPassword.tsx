...
import { clientIdUpdatePassword } from "@/lib/actions/clientAuthAction";

type ClientPasswordProps = {
  id: string;
  children?: React.ReactNode;
  onActionSuccess?: () => void;
};

const ClientPassword = ({ id, children, onActionSuccess }: ClientPasswordProps) => {
  ...
  const onSubmit = handleSubmit(async (val) => {
    try {
      await clientIdUpdatePassword(id, val);
      setModal(false);
      toast("OK");
